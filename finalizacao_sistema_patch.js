...
window.buscarClientesFinal=function(){ window.__clientesBuscaFinal=txt(document.getElementById('clientes-busca-final')?.value); window.__clientesCampoFinal=txt(document.getElementById('clientes-campo-final')?.value)||'todos'; renderClientes(); };
