...
window.buscarClientesFinal=function(){ window.__clientesTodosFinal=false; window.__clientesBuscaFinal=txt(document.getElementById('clientes-busca-final')?.value); window.__clientesCampoFinal=txt(document.getElementById('clientes-campo-final')?.value)||'todos'; renderClientes(); };
window.clientesMostrarTodos=function(){ window.__clientesTodosFinal=true; window.__clientesBuscaFinal=''; window.__clientesCampoFinal='todos'; window.__clientesStatusFinal='ativos'; window.__clientesSortFinal=window.__clientesSortFinal||{col:'codigo',dir:'asc'}; renderClientes(); };
