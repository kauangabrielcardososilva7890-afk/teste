...
ok(man[man.length - 19] === 'ajustes_v52296_backups_nuvem_patch.js' && man[man.length - 18] === 'ajustes_v5240_relatorio_grande_patch.js' && man[man.length - 17] === 'ajustes_v5243_cliente_abas_patch.js' && man[man.length - 16] === 'ajustes_v52435_impressora_remanejo_final_patch.js' && man[man.length - 15] === 'ajustes_v52436_leitura_uma_aberta_patch.js' && man[man.length - 14] === 'ajustes_v5250_leitura_overhaul_patch.js' && man[man.length - 13] === 'ajustes_v5260_cnpj_gerente_patch.js' && man[man.length - 12] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && man[man.length - 11] === 'ajustes_v5264_chamado_data_grande_patch.js' && man[man.length - 10] === 'painel_gerente_patch.js' && man[man.length - 9] === 'fiscal_guard_patch.js' && man[man.length - 8] === 'nf_transmissao_patch.js' && man[man.length - 7] === 'autocura_empresa_central_nf_tela_patch.js', 'patch de backups no fim do bundle (16º a partir do fim; v5.24.0 depois, v5.24.3, v5.24.35, v5.24.36, v5.25.0 revisão, v5.26.0 CNPJ+gerente, v5.26.2 login da nuvem primeiro, v5.26.4 data grande do chamado e Painel do Gerente v6.0.6 fecha a fila)');
