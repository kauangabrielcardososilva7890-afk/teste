...
ok(worker.indexOf("const WORKER_VERSION = '5.26.5'") >= 0 && worker.indexOf('versao: WORKER_VERSION') >= 0, '/health carimba a versão da nuvem (re-ancorado: v5.26.1 = site profissional (visual+rodapé novo); v5.26.0 = motor do CNPJ+gerente)');
