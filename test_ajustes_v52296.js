...
ok(worker.indexOf("const WORKER_VERSION = '5.26.8'") >= 0 && worker.indexOf('versao: WORKER_VERSION') >= 0, '/health carimba a versão da nuvem (re-ancorado: v5.26.1 = site profissional (visual+rodapé novo); v5.26.0 = motor do CNPJ+gerente)');
...
ok(man[man.length - 33] === 'ajustes_v52296_backups_nuvem_patch.js' && man[man.length - 32] === 'ajustes_v5240_relatorio_grande_patch.js' && man[man.length - 31] === 'ajustes_v5243_cliente_abas_patch.js' && man[man.length - 30] === 'ajustes_v52435_impressora_remanejo_final_patch.js' && man[man.length - 29] === 'ajustes_v52436_leitura_uma_aberta_patch.js' && man[man.length - 28] === 'ajustes_v5250_leitura_overhaul_patch.js' && man[man.length - 27] === 'ajustes_v5260_cnpj_gerente_patch.js' && man[man.length - 26] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && man[man.length - 25] === 'ajustes_v5264_chamado_data_grande_patch.js' && man[man.length - 24] === 'painel_gerente_patch.js' && man[man.length - 23] === 'fiscal_guard_patch.js' && man[man.length - 22] === 'nf_transmissao_patch.js' && man[man.length - 21] === 'autocura_empresa_central_nf_tela_patch.js', 'patch de backups no fim do bundle (16º a partir do fim; v5.24.0 depois, v5.24.3, v5.24.35, v5.24.36, v5.25.0 revisão, v5.26.0 CNPJ+gerente, v5.26.2 login da nuvem primeiro, v5.26.5 data grande do chamado e Painel do Gerente v6.0.6 fecha a fila)');
