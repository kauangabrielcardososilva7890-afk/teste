...
ok(man[man.length - 9] === 'ajustes_v52296_backups_nuvem_patch.js' && man[man.length - 8] === 'ajustes_v5240_relatorio_grande_patch.js' && man[man.length - 7] === 'ajustes_v5243_cliente_abas_patch.js' && man[man.length - 6] === 'ajustes_v52435_impressora_remanejo_final_patch.js' && man[man.length - 5] === 'ajustes_v52436_leitura_uma_aberta_patch.js' && man[man.length - 4] === 'ajustes_v5250_leitura_overhaul_patch.js' && man[man.length - 3] === 'ajustes_v5260_cnpj_gerente_patch.js' && man[man.length - 2] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && man[man.length - 1] === 'ajustes_v5264_chamado_data_grande_patch.js', 'patch de backups no fim do bundle (9º a partir do fim; v5.24.0 depois, v5.24.3, v5.24.35, v5.24.36, v5.25.0 revisão, v5.26.0 CNPJ+gerente, v5.26.2 login da nuvem primeiro, e v5.26.4 data grande do chamado fecha a fila)');
