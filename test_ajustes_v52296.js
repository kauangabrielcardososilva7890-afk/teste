...
// v5.24.24 — SUPERSESSÃO: ele assinou o Workers Paid US$5 (confirmado em
...
ok(worker.indexOf('tetoEscritas: 50000000') >= 0 && worker.indexOf('tetoLeituras: 25000000000') >= 0, 'tetos do plano PAGO (50M escritas / 25B leituras por mês) — supersede o grátis desde v5.24.24');
...
ok(worker.indexOf("const WORKER_VERSION = '5.24.24'") >= 0 && worker.indexOf('versao: WORKER_VERSION') >= 0, '/health carimba a versão da nuvem');
