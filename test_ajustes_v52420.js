// test_ajustes_v52420.js — v5.24.20: pedido dele "muda a estrutura completa
...
ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.24.20'"), 'index: versão 5.24.20');
ok(fs.readFileSync('index.html', 'utf8').includes('>v5.24.20<'), 'index: rodapé v5.24.20');
ok(fs.readFileSync('package.json', 'utf8').includes('"version": "5.24.20"'), 'package.json 5.24.20');

if (falhas > 0) { console.error(`\n${falhas} assert(s) FALHARAM`); process.exit(1); }
console.log('\nTudo OK — v5.24.20 (estrutura no idioma pago + ponto de recuo de 1 mês).');
