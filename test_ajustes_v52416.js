// test_ajustes_v52416.js — v5.24.24: NOVA FUNÇÃO aprovada por ele (desenho
...
ok(av.includes('v5.24.24'), 'avisos: carimbo v5.24.24');
...
ok(v5197.includes('v5.24.24'), 'v5197: carimbo da auditoria visível');
...
console.log('\nTudo OK — v5.24.24 (erro.txt visível + aviso 2 botões + auditoria pra todos).');
