// test_ajustes_v52416.js — v5.24.18: NOVA FUNÇÃO aprovada por ele (desenho
...
ok(av.includes('v5.24.18'), 'avisos: carimbo v5.24.18');
...
ok(v5197.includes('v5.24.18'), 'v5197: carimbo da auditoria visível');
...
console.log('\nTudo OK — v5.24.18 (erro.txt visível + aviso 2 botões + auditoria pra todos).');
