// test_ajustes_v52413.js — v5.24.30: LOTE 1 da poda (as 14 perguntas aplicadas
...
ok(idx.includes('app.bundle.js?v=5.24.30'), 'index: cache-bust v5.24.30');
ok(fs.readFileSync('mobile/www/index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.24.30'"), 'mobile: versão 5.24.30');
...
console.log('\nTudo OK — v5.24.30 (lote 1: ~75KB de peso morto fora, zero código morto chamável).');
