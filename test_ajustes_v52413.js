// test_ajustes_v52413.js — v5.24.22: LOTE 1 da poda (as 14 perguntas aplicadas
...
ok(idx.includes('app.bundle.js?v=5.24.22'), 'index: cache-bust v5.24.22');
ok(fs.readFileSync('mobile/www/index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.24.22'"), 'mobile: versão 5.24.22');
...
console.log('\nTudo OK — v5.24.22 (lote 1: ~75KB de peso morto fora, zero código morto chamável).');
