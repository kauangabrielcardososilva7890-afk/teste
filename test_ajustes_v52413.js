// test_ajustes_v52413.js — v5.24.28: LOTE 1 da poda (as 14 perguntas aplicadas
...
ok(idx.includes("DIGICOPY_APP_VERSION = '5.24.28'"), 'index: versão 5.24.28');
ok(idx.includes('>v5.24.28<'), 'index: rodapé v5.24.28');
ok(idx.includes('app.bundle.js?v=5.24.28'), 'index: cache-bust v5.24.28');
ok(fs.readFileSync('mobile/www/index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.24.28'"), 'mobile: versão 5.24.28');
ok(fs.readFileSync('package.json', 'utf8').includes('"version": "5.24.28"'), 'package.json: 5.24.28');
ok(fs.readFileSync('cloudflare-worker/src/index.js', 'utf8').includes("'5.24.28'"), 'worker: 5.24.28');

if (falhas > 0) { console.error(`\n${falhas} assert(s) FALHARAM`); process.exit(1); }
console.log('\nTudo OK — v5.24.28 (lote 1: ~75KB de peso morto fora, zero código morto chamável).');
