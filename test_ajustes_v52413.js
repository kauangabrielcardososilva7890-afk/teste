// test_ajustes_v52413.js — v5.24.31: LOTE 1 da poda (as 14 perguntas aplicadas
...
ok(idx.includes('app.bundle.js?v=5.24.31'), 'index: cache-bust v5.24.31');
ok(fs.readFileSync('mobile/www/index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.24.31'"), 'mobile: versão 5.24.31');
...
console.log('\nTudo OK — v5.24.31 (lote 1: ~75KB de peso morto fora, zero código morto chamável).');
