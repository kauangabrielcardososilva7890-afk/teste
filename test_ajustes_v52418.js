// test_ajustes_v52418.js — v5.24.21: (A) pedido dele "botão visível pra baixar"
...
ok(wk.includes("'5.24.21'"), 'worker carimbado 5.24.21');

if (falhas > 0) { console.error(`\n${falhas} assert(s) FALHARAM`); process.exit(1); }
console.log('\nTudo OK — v5.24.21 (botão erro.txt no rodapé + teto do plano pago destravado).');
