...
ok('app (package.json) na 6.0.8 (escola: ralo fechado)', pkg.version === '6.0.8');
ok('index.html carimbado 6.0.8 (versão real + rodapé)', html.indexOf("DIGICOPY_APP_VERSION = '6.0.8'") >= 0 && html.indexOf('>v6.0.8<') >= 0);
...
ok('manifesto hoje tem 213; posições 202/203 históricas intactas (login-nuvem, data grande); menus fiscais separados v6.0.8 fecha a fila', manifest.length === 213 && manifest[202] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && manifest[203] === 'ajustes_v5264_chamado_data_grande_patch.js');
