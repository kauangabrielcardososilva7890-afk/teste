...
ok('app (package.json) na 6.0.6 (escola: ralo fechado)', pkg.version === '6.0.6');
ok('index.html carimbado 6.0.6 (versão real + rodapé)', html.indexOf("DIGICOPY_APP_VERSION = '6.0.6'") >= 0 && html.indexOf('>v6.0.6<') >= 0);
...
ok('manifesto sobe pra 204 e fecha com a data grande do chamado', manifest.length === 211 && manifest[202] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && manifest[203] === 'ajustes_v5264_chamado_data_grande_patch.js');
