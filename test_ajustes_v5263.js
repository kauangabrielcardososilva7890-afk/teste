...
ok('app (package.json) na 6.0.9 (escola: ralo fechado)', pkg.version === '6.0.10');
...
ok('manifesto hoje tem 215; posições 202/203 históricas intactas (login-nuvem, data grande); 6 submenus do sistema antigo v6.0.10 fecha a fila', manifest.length === 215 && manifest[202] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && manifest[203] === 'ajustes_v5264_chamado_data_grande_patch.js');
