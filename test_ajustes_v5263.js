...
console.log('== CONTEXT: carimbos e trilha da v5.26.3 ==');
ok('gerente package 5.26.3', gPkg.version === '5.26.3');
ok('app (package.json) na 5.26.3', pkg.version === '5.26.3');
ok('index.html carimbado 5.26.3 (versão real + rodapé)', html.indexOf("DIGICOPY_APP_VERSION = '5.26.3'") >= 0 && html.indexOf('>v5.26.3<') >= 0);
...
ok('manifesto continua 203 e fecha com o patch login-nuvem', manifest.length === 203 && manifest[202] === 'ajustes_v5262_login_nuvem_primeiro_patch.js');
