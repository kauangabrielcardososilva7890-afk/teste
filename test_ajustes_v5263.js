...
ok('app (package.json) na 6.0.1 (escola: ralo fechado)', pkg.version === '6.0.1');
...
ok('manifesto sobe pra 204 e fecha com a data grande do chamado', manifest.length === 207 && manifest[202] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && manifest[203] === 'ajustes_v5264_chamado_data_grande_patch.js');
