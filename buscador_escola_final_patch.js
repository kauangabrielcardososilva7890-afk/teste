// ═══════════════════════════════════════════════════════════════════════════
// PATCH v4.9.67 — Buscador Escola final
...
window.salvarCredenciaisBuscador=function(){ const c=cfgFinal(db); c.credenciais={usuario:txt(document.getElementById('be-usuario')?.value),senha:txt(document.getElementById('be-senha')?.value)}; c.credenciaisSalvasEm=agora(); salvar(); toastMsg('Credenciais salvas. Você não precisa digitar novamente.','success'); renderBuscadorEscolaFinal('Credenciais salvas. A sincronização automática usará esses dados.'); };
...
window.BUSCADOR_ESCOLA_FINAL_PURE={cfgFinal,storeFinal,normalizarOrc,normalizarItem,pesquisarFinal,credOk,deveAutoSync,excelHtmlFinal};
...
console.log('[DIGICOPY] buscador_escola_final_patch.js v4.9.67 carregado');
})();
