...
ok('manifesto já é 220 (Menu Fiscal oficial v6.1.0 por último); o catálogo da 6.0.14 ficou na posição histórica 218 (por cima do ribbon)',
  man.length === 221 && man[218] === 'fiscal_catalogo_completo_patch.js' && man[217] === 'ribbon_fiscal_estilo_antigo_patch.js');
...
ok('carimbo v6.0.14 (package + index + query do bundle)',
  pkg.version === '6.1.1' && html.indexOf("DIGICOPY_APP_VERSION = '6.1.1'") >= 0 && html.indexOf('v6.1.1</title>') >= 0 && html.indexOf('app.bundle.js?v=6.1.1') >= 0);
