...
window.clitabExcluir=function(){
  ...
  function executar(){
    ...
    // v5.24.28 — varre os fantasmas das telas dos módulos: sem isso, a tela de
...
window.clitabAbrirLista=function(){
  ...
  // v5.24.28 — TRAVA DE SEGURANÇA: antes, qualquer sub desconhecido caía no
  ...
  setTimeout(function(){
    ...
    // v5.24.28 — pedido dele: "abrir já mostrando aquilo que eu escolhi".
...
// v5.24.28 — pedido dele: "o clientes não abre a lista que mostra os que eu
...
// v5.24.28 — A LISTA SÓ COM O QUE ELE MARCOU (pedido dele, literal: "quero
...
// v5.24.28 — O ABRIDOR DIRETO: abre o REGISTRO ESPECÍFICO no módulo de origem,
