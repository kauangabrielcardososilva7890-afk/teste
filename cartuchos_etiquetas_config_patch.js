...
function htmlEtiquetas(codigos,opt={}){
  const c={colunas:ETQ_COLUNAS,linhas:ETQ_LINHAS,larguraMm:16,alturaMm:9,margemSuperiorMm:5,margemEsquerdaMm:5,espacoHorizontalMm:1.5,espacoVerticalMm:1.2,usarCodigoBarras:true,...(opt||{})};
