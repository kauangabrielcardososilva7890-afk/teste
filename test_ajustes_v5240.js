...
ok(manifest[manifest.length - 2] === 'ajustes_v5240_relatorio_grande_patch.js' && manifest[manifest.length - 1] === 'ajustes_v5243_cliente_abas_patch.js' && manifest.length === 196, 'manifest tem 196 scripts, v5.24.0 penúltimo e v5.24.23 último');
