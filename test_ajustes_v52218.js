...
ok('versão 5.22.18 no código base', /app\.bundle\.js\?v=[56]\.\d+\.\d+/.test(html) && (parseInt(String(pkg.version).split('.')[0],10)>=6 || parseInt(String(pkg.version).split('.')[1],10)>=23 || parseInt(String(pkg.version).split('.')[2],10)>=18));
