...
ok('manifesto sobe pra 212; Início clicável fecha a fila',
  man.length === 212 && man[211] === 'dashboard_inicio_clicavel_patch.js' && man[210] === 'fiscal_menu_completo_patch.js' && man[209] === 'permissoes_estorno_venda_patch.js' && man[205] === 'fiscal_guard_patch.js');
...
ok('index.html carimbado (versão real + rodapé + query)',
  html.indexOf("DIGICOPY_APP_VERSION = '6.0.7'") >= 0 && html.indexOf('>v6.0.7<') >= 0 && html.indexOf('app.bundle.js?v=6.0.7') >= 0);
