...
ok(indexHtml.indexOf("DIGICOPY_APP_VERSION = '6.0.14'") >= 0, 'index.html carimbado (re-ancorado v6.0.9)');
ok(indexMob.indexOf("DIGICOPY_APP_VERSION = '6.0.14'") >= 0, 'mobile/www/index.html carimbada (re-ancorado v6.0.9)');
ok(pkg.version === '6.0.14', 'package.json carimbado (re-ancorado v6.0.9)');
