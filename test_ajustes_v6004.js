...
ok('manifesto sobe pra 213; menus fiscais separados v6.0.8 fecha a fila', man.length === 214 && man[208] === 'perfis_nuvem_cura_sessao_patch.js' && man[209] === 'permissoes_estorno_venda_patch.js' && man[210] === 'fiscal_menu_completo_patch.js' && man[211] === 'dashboard_inicio_clicavel_patch.js' && man[212] === 'menus_fiscais_separados_patch.js' && man[213] === 'permissoes_override_menus_fiscais_patch.js' && man[205] === 'fiscal_guard_patch.js' && man[206] === 'nf_transmissao_patch.js' && man[207] === 'autocura_empresa_central_nf_tela_patch.js');
...
ok('package.json na 6.0.4', pkg.version === '6.0.9');
...
ok('celular carimbado 6.0.4', mob.indexOf("DIGICOPY_APP_VERSION = '6.0.9'") >= 0 && mob.indexOf('>v6.0.9<') >= 0);
