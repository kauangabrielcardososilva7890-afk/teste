...
ok('manifesto sobe pra 210; v6.0.5 fecha a fila', man.length === 210 && man[208] === 'perfis_nuvem_cura_sessao_patch.js' && man[209] === 'permissoes_estorno_venda_patch.js' && man[205] === 'fiscal_guard_patch.js' && man[206] === 'nf_transmissao_patch.js' && man[207] === 'autocura_empresa_central_nf_tela_patch.js');
...
ok('package.json na 6.0.4', pkg.version === '6.0.5');
ok('index.html carimbado (versão real + rodapé)', html.indexOf("DIGICOPY_APP_VERSION = '6.0.5'") >= 0 && html.indexOf('>v6.0.5<') >= 0 && html.indexOf('app.bundle.js?v=6.0.5') >= 0);
ok('celular carimbado 6.0.4', mob.indexOf("DIGICOPY_APP_VERSION = '6.0.5'") >= 0 && mob.indexOf('>v6.0.5<') >= 0);
