...
ok('package.json na 6.0.4', pkg.version === '6.0.10');
...
ok('celular carimbado 6.0.4', mob.indexOf("DIGICOPY_APP_VERSION = '6.0.10'") >= 0 && mob.indexOf('>v6.0.10<') >= 0);
