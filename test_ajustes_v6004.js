...
ok('package.json na 6.0.4', pkg.version === '6.1.1');
ok('index.html carimbado (versão real + rodapé)', html.indexOf("DIGICOPY_APP_VERSION = '6.1.1'") >= 0 && html.indexOf('>v6.1.1<') >= 0 && html.indexOf('app.bundle.js?v=6.1.1') >= 0);
ok('celular carimbado 6.0.4', mob.indexOf("DIGICOPY_APP_VERSION = '6.1.1'") >= 0 && mob.indexOf('>v6.1.1<') >= 0);
