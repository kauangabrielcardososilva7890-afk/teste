...
ok('manifesto já é 225 (v6.1.3 fecha a fila com navegação fiscal na barra + escuro íntegro)', manifest.length >= 225 && manifest[manifest.length - 19] === 'autocura_empresa_central_nf_tela_patch.js' && manifest[manifest.length - 18] === 'perfis_nuvem_cura_sessao_patch.js' && manifest[manifest.length - 17] === 'permissoes_estorno_venda_patch.js' && manifest[manifest.length - 16] === 'fiscal_menu_completo_patch.js' && manifest[manifest.length - 15] === 'dashboard_inicio_clicavel_patch.js' && manifest[manifest.length - 14] === 'menus_fiscais_separados_patch.js' && manifest[manifest.length - 13] === 'permissoes_override_menus_fiscais_patch.js' && manifest[manifest.length - 12] === 'seis_submenus_velho_patch.js' && manifest[manifest.length - 11] === 'submenu_hover_nfe_patch.js' && manifest[manifest.length - 10] === 'navegacao_sem_tela_branca_patch.js' && manifest[manifest.length - 9] === 'ribbon_fiscal_estilo_antigo_patch.js' && manifest[manifest.length - 8] === 'fiscal_catalogo_completo_patch.js');
