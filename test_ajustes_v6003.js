...
ok('package.json na 6.0.3', pkg.version === '6.1.1');
ok('index.html carimbado 6.0.3', html.indexOf("DIGICOPY_APP_VERSION = '6.1.1'") >= 0 && html.indexOf('>v6.1.1<') >= 0);
ok('manifesto já é 219 (v6.0.14 fecha a fila com as 6 telas fiscais completas do catálogo)', manifest.length === 221 && manifest[manifest.length - 14] === 'autocura_empresa_central_nf_tela_patch.js' && manifest[manifest.length - 13] === 'perfis_nuvem_cura_sessao_patch.js' && manifest[manifest.length - 12] === 'permissoes_estorno_venda_patch.js' && manifest[manifest.length - 11] === 'fiscal_menu_completo_patch.js' && manifest[manifest.length - 10] === 'dashboard_inicio_clicavel_patch.js' && manifest[manifest.length - 9] === 'menus_fiscais_separados_patch.js' && manifest[manifest.length - 8] === 'permissoes_override_menus_fiscais_patch.js' && manifest[manifest.length - 7] === 'seis_submenus_velho_patch.js' && manifest[manifest.length - 6] === 'submenu_hover_nfe_patch.js' && manifest[manifest.length - 5] === 'navegacao_sem_tela_branca_patch.js' && manifest[manifest.length - 4] === 'ribbon_fiscal_estilo_antigo_patch.js' && manifest[manifest.length - 3] === 'fiscal_catalogo_completo_patch.js');
