...
ok('versão 5.22.55 base', P.VERSAO === '5.22.55' && /^[56]\.\d+\.\d+/.test(pkg.version));
...
ok('index carrega scripts na versão 5.22', /app\.bundle\.js\?v=[56]\.\d+\.\d+/.test(html) && JSON.parse(fs.readFileSync('bundle-manifest.json','utf8')).includes('ajustes_v52255_orcamento_aprovacao_venda_patch.js'));
