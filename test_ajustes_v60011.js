...
ok('manifesto sobe pra 216; hover NF-e/NFC-e fecha a fila',
  man.length === 216 && man[215] === 'submenu_hover_nfe_patch.js' && man[214] === 'seis_submenus_velho_patch.js' && man[213] === 'permissoes_override_menus_fiscais_patch.js');
...
ok('package.json na 6.0.11', pkg.version === '6.0.11');
...
ok('celular carimbado 6.0.11', mob.indexOf("DIGICOPY_APP_VERSION = '6.0.11'") >= 0 && mob.indexOf('>v6.0.11<') >= 0);
