...
ok('manifesto sobe pra 216; hover NF-e/NFC-e fecha a fila',
  man.length === 218 && man[215] === 'submenu_hover_nfe_patch.js' && man[214] === 'seis_submenus_velho_patch.js' && man[213] === 'permissoes_override_menus_fiscais_patch.js');
...
ok('clicar no pai NF-e/NFC-e abre a Central (Nota Fiscal) — padrão dos módulos vizinhos',
  /<div class="module"><button onclick="navigateTo\('central-nf'\)"><i class="ph ph-file-text"><\/i>NF-e\/NFC-e<\/button><div id="menu-nfe"/.test(html));
...
ok('package.json na 6.0.11', pkg.version === '6.0.13');
ok('index.html carimbado (4 pontos)', html.indexOf("DIGICOPY_APP_VERSION = '6.0.13'") >= 0 && html.indexOf('>v6.0.13<') >= 0 && html.indexOf('app.bundle.js?v=6.0.13') >= 0 && html.indexOf('v6.0.13</title>') >= 0);
ok('celular carimbado 6.0.11', mob.indexOf("DIGICOPY_APP_VERSION = '6.0.13'") >= 0 && mob.indexOf('>v6.0.13<') >= 0);
