// test_ajustes_v52422.js — v5.24.28: pacote 2A do RELATORIO GRANDE.
...
ok(main.includes('v5.24.28'), 'main.js com o comentário da versão');
ok(prel.includes("'5.24.28'") || prel.includes("v5.24.28") || prel.includes('5.24.28'), 'preload carimbado');

if (falhas > 0) { console.error(`\n${falhas} assert(s) FALHARAM`); process.exit(1); }
console.log('\nTudo OK — v5.24.28 pacote 2A (F1 contratos-hoje, F2 chamados excluir+imprimir, P6 RTF no Word).');
