...
(async function(){
  ...
  ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.26.2'"), 'index 5.26.2');
  ok(fs.readFileSync('index.html', 'utf8').includes('>v5.26.2<'), 'rodapé v5.26.2');
