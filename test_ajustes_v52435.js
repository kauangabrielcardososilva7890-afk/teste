...
(async function(){
  ...
  ok(man[man.length-8] === 'ajustes_v52435_impressora_remanejo_final_patch.js' && man[man.length-6] === 'ajustes_v5250_leitura_overhaul_patch.js' && man[man.length-5] === 'ajustes_v5260_cnpj_gerente_patch.js' && man[man.length-4] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && man[man.length-3] === 'ajustes_v5264_chamado_data_grande_patch.js' && man[man.length-2] === 'painel_gerente_patch.js' && man[man.length-1] === 'fiscal_guard_patch.js', 'manifest: remanejo sexto a partir do fim; depois revisão v5.25.0, CNPJ+gerente v5.26.0, login da nuvem v5.26.2, a data grande do chamado v5.26.4 e o Painel do Gerente v6.0.0 fecha a fila (vence sempre)');
