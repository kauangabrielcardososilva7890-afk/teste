...
(async function(){
  ...
  ok(man[man.length-26] === 'ajustes_v52436_leitura_uma_aberta_patch.js' && man[man.length-25] === 'ajustes_v5250_leitura_overhaul_patch.js' && man[man.length-24] === 'ajustes_v5260_cnpj_gerente_patch.js' && man[man.length-23] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && man[man.length-22] === 'ajustes_v5264_chamado_data_grande_patch.js' && man[man.length-21] === 'painel_gerente_patch.js' && man[man.length-20] === 'fiscal_guard_patch.js' && man[man.length-19] === 'nf_transmissao_patch.js' && man[man.length-18] === 'autocura_empresa_central_nf_tela_patch.js' && man[man.length-17] === 'perfis_nuvem_cura_sessao_patch.js' && man[man.length-16] === 'permissoes_estorno_venda_patch.js' && man[man.length-15] === 'fiscal_menu_completo_patch.js' && man[man.length-14] === 'dashboard_inicio_clicavel_patch.js' && man[man.length-13] === 'menus_fiscais_separados_patch.js' && man[man.length-12] === 'permissoes_override_menus_fiscais_patch.js' && man[man.length-11] === 'seis_submenus_velho_patch.js' && man[man.length-10] === 'submenu_hover_nfe_patch.js' && man[man.length-9] === 'navegacao_sem_tela_branca_patch.js' && man[man.length-8] === 'ribbon_fiscal_estilo_antigo_patch.js', 'manifest: remanejo, guarda, revisao v5.25.0, CNPJ v5.26.0, login v5.26.2, chamado v5.26.4, painel, portao v6.0.0, transmissao, autocura, perfis, permissões, menu fiscal, Início clicável, menus separados; override v6.0.9; 6 submenus v6.0.10; hover NF-e/NFC-e v6.0.11; anti-tela-branca v6.0.12; ribbon fiscal bonita v6.0.13 (mantido na fila; v6.1.3 navegação+escuro fecha a fila)');
