...
(async function(){
  ...
  ok(man[man.length-17] === 'ajustes_v52436_leitura_uma_aberta_patch.js' && man[man.length-16] === 'ajustes_v5250_leitura_overhaul_patch.js' && man[man.length-15] === 'ajustes_v5260_cnpj_gerente_patch.js' && man[man.length-14] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && man[man.length-13] === 'ajustes_v5264_chamado_data_grande_patch.js' && man[man.length-12] === 'painel_gerente_patch.js' && man[man.length-11] === 'fiscal_guard_patch.js' && man[man.length-10] === 'nf_transmissao_patch.js' && man[man.length-9] === 'autocura_empresa_central_nf_tela_patch.js' && man[man.length-8] === 'perfis_nuvem_cura_sessao_patch.js' && man[man.length-7] === 'permissoes_estorno_venda_patch.js' && man[man.length-6] === 'fiscal_menu_completo_patch.js' && man[man.length-5] === 'dashboard_inicio_clicavel_patch.js' && man[man.length-4] === 'menus_fiscais_separados_patch.js' && man[man.length-3] === 'permissoes_override_menus_fiscais_patch.js' && man[man.length-2] === 'seis_submenus_velho_patch.js' && man[man.length-1] === 'submenu_hover_nfe_patch.js', 'manifest: remanejo, guarda, revisao v5.25.0, CNPJ v5.26.0, login v5.26.2, chamado v5.26.4, painel, portao v6.0.0, transmissao, autocura, perfis, permissões, menu fiscal, Início clicável, menus separados; override v6.0.9; 6 submenus v6.0.10; hover NF-e/NFC-e v6.0.11 fecha a fila (vence sempre)');
  ...
  ok(fs.readFileSync('mobile/www/index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '6.0.11'"), 'celular 6.0.9');
  ok(JSON.parse(fs.readFileSync('package.json', 'utf8')).version === '6.0.11', 'package.json 6.0.9');
