...
(async function(){
  ...
  ok(man[man.length-12] === 'ajustes_v52436_leitura_uma_aberta_patch.js' && man[man.length-11] === 'ajustes_v5250_leitura_overhaul_patch.js' && man[man.length-10] === 'ajustes_v5260_cnpj_gerente_patch.js' && man[man.length-9] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && man[man.length-8] === 'ajustes_v5264_chamado_data_grande_patch.js' && man[man.length-7] === 'painel_gerente_patch.js' && man[man.length-6] === 'fiscal_guard_patch.js' && man[man.length-5] === 'nf_transmissao_patch.js' && man[man.length-4] === 'autocura_empresa_central_nf_tela_patch.js' && man[man.length-3] === 'perfis_nuvem_cura_sessao_patch.js' && man[man.length-2] === 'permissoes_estorno_venda_patch.js' && man[man.length-1] === 'fiscal_menu_completo_patch.js', 'manifest: remanejo, depois guarda, revisao v5.25.0, CNPJ v5.26.0, login v5.26.2, chamado v5.26.4, painel, portao v6.0.0, transmissao; perfis+cura; permissões+estorno v6.0.6 fecha a fila (vence sempre)');
