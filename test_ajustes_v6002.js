...
ok('patch na 208; perfis 209; permissões v6.0.5 fecha a fila (210)', manifest.length === 210 && manifest[207] === 'autocura_empresa_central_nf_tela_patch.js' && manifest[208] === 'perfis_nuvem_cura_sessao_patch.js' && manifest[209] === 'permissoes_estorno_venda_patch.js');
...
ok('package.json na 6.0.2', pkg.version === '6.0.5');
ok('index.html carimbado 6.0.2', html.indexOf("DIGICOPY_APP_VERSION = '6.0.5'") >= 0 && html.indexOf('>v6.0.5<') >= 0);
