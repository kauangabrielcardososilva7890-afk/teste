...
ok('patch na 208; perfis 209; permissões 210; menu fiscal v6.0.6; Início clicável v6.0.7; menus fiscais separados v6.0.8 fecha a fila (213)', manifest.length === 213 && manifest[207] === 'autocura_empresa_central_nf_tela_patch.js' && manifest[208] === 'perfis_nuvem_cura_sessao_patch.js' && manifest[209] === 'permissoes_estorno_venda_patch.js' && manifest[210] === 'fiscal_menu_completo_patch.js' && manifest[211] === 'dashboard_inicio_clicavel_patch.js' && manifest[212] === 'menus_fiscais_separados_patch.js');
...
ok('package.json na 6.0.2', pkg.version === '6.0.8');
ok('index.html carimbado 6.0.2', html.indexOf("DIGICOPY_APP_VERSION = '6.0.8'") >= 0 && html.indexOf('>v6.0.8<') >= 0);
