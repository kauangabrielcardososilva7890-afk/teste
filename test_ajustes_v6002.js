...
ok('package.json na 6.0.2', pkg.version === '6.1.0');
ok('index.html carimbado 6.0.2', html.indexOf("DIGICOPY_APP_VERSION = '6.1.0'") >= 0 && html.indexOf('>v6.1.0<') >= 0);
