...
ok('patch na 207 (autocura 208; perfis+cura v6.0.4 fecha a fila na 209)', manifest.length === 209 && manifest[206] === 'nf_transmissao_patch.js' && manifest[207] === 'autocura_empresa_central_nf_tela_patch.js' && manifest[208] === 'perfis_nuvem_cura_sessao_patch.js');
ok('motor no bundle gerado', bundle.indexOf('MOTOR FISCAL v6.0.1') >= 0);
ok('package.json na 6.0.1', pkg.version === '6.0.4');
ok('index.html carimbado 6.0.1', html.indexOf("DIGICOPY_APP_VERSION = '6.0.4'") >= 0 && html.indexOf('>v6.0.4<') >= 0);
