...
ok('patch fecha a fila do manifesto (posição 207)', manifest.length === 207 && manifest[206] === 'nf_transmissao_patch.js');
ok('motor no bundle gerado', bundle.indexOf('MOTOR FISCAL v6.0.1') >= 0);
ok('package.json na 6.0.1', pkg.version === '6.0.1');
ok('index.html carimbado 6.0.1', html.indexOf("DIGICOPY_APP_VERSION = '6.0.1'") >= 0 && html.indexOf('>v6.0.1<') >= 0);
