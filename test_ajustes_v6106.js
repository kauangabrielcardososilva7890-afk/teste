...
ok('a nuvem agora diz a versão nova (0.4.9 / 5.26.5)',
...
ok('o relatório é da versão publicada agora (v6.1.8)',
  rel.indexOf('v6.1.8') >= 0 && rel.indexOf('5.26.5') >= 0);
...
console.log('\nRESULTADO: v6.1.8 (rodada 22/09) passou!');
