...
ok('manifesto possui todos os 104 scripts na ordem',manifest.length===104&&new Set(manifest).size===104);
...
ok('Electron inclui bundle e não depende da lista manual antiga',pkg.build.files.includes('app.bundle.js')&&pkg.build.files.length<=10);
