...
const extraRuntime=['ajustes_v52249_relatorio_patch.js','ajustes_v52250_exe_bundle_patch.js','ajustes_v52251_exe_resiliencia_patch.js','ajustes_v52252_resolucao_loop_patch.js','ajustes_v52253_login_tela_branca_patch.js','ajustes_v52254_orcamentos_pages_patch.js','ajustes_v52255_orcamento_aprovacao_venda_patch.js','ajustes_v52256_orcamento_venda_limpa_patch.js','ajustes_v52257_orcamento_sync_total_patch.js','ajustes_v52258_orcamento_os_revalidar_patch.js','ajustes_v52259_orcamento_filtros_item_patch.js','ajustes_v52260_orcamento_trava_venda_atalho_patch.js','ajustes_v52261_orcamento_nao_volta_patch.js','ajustes_v52262_orcamento_uma_vez_loop_patch.js'];
...
ok('Electron inclui bundle e patches do runtime',pkg.build.files.includes('app.bundle.js')&&pkg.build.files.includes('package.json')&&pkg.build.files.includes('ajustes_v52262_orcamento_uma_vez_loop_patch.js')&&pkg.build.files.length<=30);
