...
ok('Electron inclui bundle e patches do runtime',pkg.build.files.includes('app.bundle.js')&&pkg.build.files.includes('package.json')&&pkg.build.files.includes('ajustes_v52261_orcamento_nao_volta_patch.js')&&pkg.build.files.length<=29);
