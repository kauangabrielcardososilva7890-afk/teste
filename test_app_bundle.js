...
ok('Electron inclui bundle e patches do runtime',pkg.build.files.includes('app.bundle.js')&&pkg.build.files.includes('package.json')&&pkg.build.files.includes('ajustes_v52258_orcamento_os_revalidar_patch.js')&&pkg.build.files.length<=26);
