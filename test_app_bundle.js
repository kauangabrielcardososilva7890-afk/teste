...
const extraRuntime=['ajustes_v52249_relatorio_patch.js','ajustes_v52250_exe_bundle_patch.js'];
...
ok('Electron inclui bundle e patches do runtime',pkg.build.files.includes('app.bundle.js')&&pkg.build.files.includes('package.json')&&pkg.build.files.includes('ajustes_v52250_exe_bundle_patch.js')&&pkg.build.files.length<=18);
