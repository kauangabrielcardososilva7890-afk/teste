...
const extraRuntime=['ajustes_v52249_relatorio_patch.js','ajustes_v52250_exe_bundle_patch.js','ajustes_v52251_exe_resiliencia_patch.js','ajustes_v52252_resolucao_loop_patch.js','ajustes_v52253_login_tela_branca_patch.js','ajustes_v52254_orcamentos_pages_patch.js','ajustes_v52255_orcamento_aprovacao_venda_patch.js','ajustes_v52256_orcamento_venda_limpa_patch.js'];
...
ok('Electron inclui bundle e patches do runtime',pkg.build.files.includes('app.bundle.js')&&pkg.build.files.includes('package.json')&&pkg.build.files.includes('ajustes_v52256_orcamento_venda_limpa_patch.js')&&pkg.build.files.length<=24);
