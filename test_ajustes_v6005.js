...
ok('manifesto sobe pra 210; permissões/estorno fecha a fila', man.length === 210 && man[209] === 'permissoes_estorno_venda_patch.js' && man[208] === 'perfis_nuvem_cura_sessao_patch.js' && man[205] === 'fiscal_guard_patch.js');
...
ok('celular carimbado 6.0.5', mob.indexOf("DIGICOPY_APP_VERSION = '6.0.5'") >= 0 && mob.indexOf('>v6.0.5<') >= 0);
