...
ok('package.json na 6.0.5', pkg.version === '6.1.1');
...
ok('celular carimbado 6.0.5', mob.indexOf("DIGICOPY_APP_VERSION = '6.1.1'") >= 0 && mob.indexOf('>v6.1.1<') >= 0);
