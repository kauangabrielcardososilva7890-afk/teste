// test_ajustes_v52426.js — v5.24.27: pedido dele "faz logo" (sprint NF): a
...
ok(cn.includes('NFE_CENTRAL_V52426'), 'central: exportação pure v5.24.27');
...
console.log('\nTudo OK — v5.24.27 (histórico das notas assinadas na Central NF).');
