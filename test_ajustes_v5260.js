...
ok('manifesto fecha com a data grande do chamado (posição 204; login-nuvem na 203, v5.26.0 na 202)', manifest.length === 206 && manifest[201] === 'ajustes_v5260_cnpj_gerente_patch.js' && manifest[202] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && manifest[203] === 'ajustes_v5264_chamado_data_grande_patch.js');
ok('package.json na 5.26.0', pkg.version === '6.0.0');
ok('index.html carimbado (versão real + rodapé)', html.indexOf("DIGICOPY_APP_VERSION = '6.0.0'") >= 0 && html.indexOf('>v6.0.0<') >= 0);
