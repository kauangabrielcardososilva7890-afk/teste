// ═══════════════════════════════════════════════════════════════════════════
// v5.24.31 — CENTRAL DE NOTA FISCAL (relatório dele: "os menus de NF não
...
async function conferirValidadeAgora(){
  ...
  if(!api||typeof api.validade!=='function'){
    tn('A conferência de validade precisa do programinha (.exe) novo — atualize pra v5.24.31.','info'); return;
  }
  var senha=null;
  try{
...
// ── Histórico das notas assinadas neste PC (v5.24.31 — pedido dele) ──────────
...
console.log('[DIGICOPY] Central de Nota Fiscal pronta (v5.24.31) — menu NF abre de verdade');
})();
