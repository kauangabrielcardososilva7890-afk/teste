...
// v5.24.30 — PEDIDO DELE (mudou o destino do detalhe): erro indevido NÃO vai
...
// v5.24.30 — PEDIDO DELE: o erro não mora mais na auditoria. Agora vira linha
...
// v5.24.30 — resposta à pergunta dele: "e se eu perder o aviso, como baixo de
...
// v5.24.30 — pedido dele: BOTÃO visível pra abrir/baixar o erro.txt (o
...
// v5.24.30 — SININHO DE ATUALIZAÇÃO (pedido dele): quando abrir o sistema e
...
function mostrarAvisoAtualizacao(rel){
  ...
  document.getElementById('aviso-update-baixar').onclick=function(){
    marcarVisto();
    // v5.24.30 — pedido dele: o botão leva pro SITE (tutorial dele, se houver,
...
// v5.24.30 — o card publicador nas Configurações (ele marca a versão, cola o
// link do .exe, escreve as notas — ou me pede pra escrever, como ele disse).
function aplicarCardPublicarAtualizacao(){
  // v5.24.30 — O PORTAL É SÓ DELE (antes era só "publicar"): publicar com
  ...
  card.innerHTML=
    ...
    '<div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">'+
      '<div><label class="text-[11px] uppercase font-bold text-slate-500">Versão nova</label><input id="pub-upd-versao" class="mt-1 w-full h-10 px-3 rounded-xl border text-[13px] font-mono" placeholder="5.24.30"></div>'+
...
// v5.24.30 — caminho de resgate: baixar o erro.txt por fora do aviso (console
