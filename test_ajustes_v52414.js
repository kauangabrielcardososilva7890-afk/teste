// test_ajustes_v52414.js — v5.24.31: bug relatado por ele (modelinho preenchido!)
...
ok(v5196.includes('v5.24.31'), 'v5196: carimbo da prova de gravação');
...
ok(v52253.includes('v5.24.31'), 'v52253: carimbo do diagnóstico partido');
...
console.log('\nTudo OK — v5.24.31 (usuário novo: salvar prova que gravou; login diz o que errou).');
