// test_ajustes_v52414.js — v5.24.14: bug relatado por ele (modelinho preenchido!)
...
ok(v5196.includes('v5.24.14'), 'v5196: carimbo da prova de gravação');
...
ok(v52253.includes('v5.24.14'), 'v52253: carimbo do diagnóstico partido');
...
ok(idx.includes('>v5.24.14<'), 'index: rodapé 5.24.14');
ok(idx.includes('app.bundle.js?v=5.24.14'), 'index: cache-bust 5.24.14');
ok(fs.readFileSync('package.json', 'utf8').includes('"version": "5.24.14"'), 'package.json 5.24.14');

if (falhas > 0) { console.error(`\n${falhas} assert(s) FALHARAM`); process.exit(1); }
console.log('\nTudo OK — v5.24.14 (usuário novo: salvar prova que gravou; login diz o que errou).');
