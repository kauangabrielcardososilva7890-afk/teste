...
ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.26.2'"), 'index: versão 5.25.0');
ok(fs.readFileSync('index.html', 'utf8').includes('>v5.26.2<'), 'index: rodapé v5.26.2');
