...
ok(wk.includes("'5.26.8'"), 'worker carimbado 5.26.8 (gerente entra como PC admin; 5.26.5 = visual profissional do site; 5.26.0 = motor do CNPJ+gerente) (visual profissional do site; o 5.26.0 foi o motor do CNPJ+gerente)')
