...
ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '6.0.12'"), 'index: versão 5.25.0');
ok(fs.readFileSync('index.html', 'utf8').includes('>v6.0.12<'), 'index: rodapé v6.0.9');
