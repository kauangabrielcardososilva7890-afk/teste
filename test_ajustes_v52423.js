...
ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '6.0.8'"), 'index: versão 5.25.0');
ok(fs.readFileSync('index.html', 'utf8').includes('>v6.0.8<'), 'index: rodapé v6.0.8');
ok(fs.readFileSync('package.json', 'utf8').includes('"version": "6.0.8"'), 'package.json 6.0.6');
