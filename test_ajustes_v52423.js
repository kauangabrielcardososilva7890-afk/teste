...
ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '6.1.0'"), 'index: versão 5.25.0');
ok(fs.readFileSync('index.html', 'utf8').includes('>v6.1.0<'), 'index: rodapé v6.0.9');
ok(fs.readFileSync('package.json', 'utf8').includes('"version": "6.1.0"'), 'package.json 6.0.6');
