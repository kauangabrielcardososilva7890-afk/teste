...
ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.24.35'"), 'index: versão 5.24.35');
ok(fs.readFileSync('index.html', 'utf8').includes('>v5.24.35<'), 'index: rodapé v5.24.35');
