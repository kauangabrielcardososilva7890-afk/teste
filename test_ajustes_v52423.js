// test_ajustes_v52423.js — v5.24.25: pedido dele "função de publicar atualizações".
...
ok(cmpVersaoMaior('5.24.25','5.24.22')===true, 'cmp: 5.24.25 > 5.24.22');
ok(cmpVersaoMaior('5.25.0','5.24.99')===true, 'cmp: 5.25.0 > 5.24.99 (não trava no 9)');
ok(cmpVersaoMaior('5.24.25','5.24.25')===false, 'cmp: igual não avisa de novo');
ok(cmpVersaoMaior('5.24.0','5.24.25')===false, 'cmp: publique velha = silêncio');
...
console.log('\nTudo OK — v5.24.25 (sininho de atualização + publicador na config).');
