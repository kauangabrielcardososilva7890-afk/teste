...
ok(fs.readFileSync('package.json', 'utf8').includes('"version": "5.26.2"'), 'package.json 5.26.2');
ok(fs.readFileSync('cloudflare-worker/src/index.js', 'utf8').includes("'5.26.2'"), 'worker carimbado (re-ancorado v5.26.2)');
