// test_ajustes_v52425.js — v5.24.33: resposta ao "os menus de NF não estão acessando".
...
ok(fs.readFileSync('cloudflare-worker/src/index.js', 'utf8').includes("'5.24.33'"), 'worker carimbado');

if (falhas > 0) { console.error(`\n${falhas} assert(s) FALHARAM`); process.exit(1); }
console.log('\nTudo OK — v5.24.33 (menu NF abre de verdade + certificado para limpo com data).');
