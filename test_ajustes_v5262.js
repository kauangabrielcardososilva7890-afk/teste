...
ok('manifesto: patch v5.26.2 na 203 (v5.26.0 na 202; fecha com a data grande do chamado na 204)', manifest.length === 210 && manifest[201] === 'ajustes_v5260_cnpj_gerente_patch.js' && manifest[202] === PATCH && manifest[203] === 'ajustes_v5264_chamado_data_grande_patch.js');
