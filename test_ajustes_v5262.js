...
ok('manifesto: patch v5.26.2 na 203 (v5.26.0 na 202; data grande do chamado na 204; fila hoje fecha na 217 com o anti-tela-branca v6.0.12', manifest.length === 217 && manifest[201] === 'ajustes_v5260_cnpj_gerente_patch.js' && manifest[202] === PATCH && manifest[203] === 'ajustes_v5264_chamado_data_grande_patch.js');
...
ok('index.html carimbado (versão real + rodapé)', html.indexOf("DIGICOPY_APP_VERSION = '6.0.12'") >= 0 && html.indexOf('>v6.0.12<') >= 0);
