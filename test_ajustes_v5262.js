...
ok('manifesto: patch v5.26.2 na 203 (v5.26.0 na 202; data grande do chamado na 204; fila hoje fecha na 213 com os menus fiscais separados v6.0.8)', manifest.length === 213 && manifest[201] === 'ajustes_v5260_cnpj_gerente_patch.js' && manifest[202] === PATCH && manifest[203] === 'ajustes_v5264_chamado_data_grande_patch.js');
