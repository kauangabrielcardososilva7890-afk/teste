...
ok('manifesto fecha com o patch v5.26.2 (posição 203; v5.26.0 na 202)', manifest.length === 203 && manifest[201] === 'ajustes_v5260_cnpj_gerente_patch.js' && manifest[202] === PATCH);
