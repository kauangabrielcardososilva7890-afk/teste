...
ok('loadFile com versão', main.indexOf('APP_VERSION')>=0 && main.indexOf('query:')>=0);
...
ok('versão', pkg.version==='5.22.47' && html.indexOf('app.bundle.js?v=5.22.47')>=0 && html.indexOf('v5.22.47')>=0);
