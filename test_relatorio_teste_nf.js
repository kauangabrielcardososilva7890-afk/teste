...
d.getElementById('d_rodape').value = 'v6.1.9 + a5f67dad';
...
ok('identificação do teste sai escrita', /Nome\.+: Dono/.test(txt) && /Programa \.exe/.test(txt) && /v6\.1\.9/.test(txt) && /5\.26\.5/.test(txt) && /a5f67dad/.test(txt));
