...
d.getElementById('d_rodape').value = 'v6.1.8 + 0c31ad7d';
...
ok('identificação do teste sai escrita', /Nome\.+: Dono/.test(txt) && /Programa \.exe/.test(txt) && /v6\.1\.8/.test(txt) && /5\.26\.5/.test(txt) && /0c31ad7d/.test(txt));
