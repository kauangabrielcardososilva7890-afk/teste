...
ok('versão 5.22.19+', (parseInt(String(pkg.version).split('.')[0],10)>=6 || parseInt(String(pkg.version).split('.')[1],10)>=23 || parseInt(String(pkg.version).split('.')[2],10)>=19) && /app\.bundle\.js\?v=[56]\.\d+\.\d+/.test(html));
