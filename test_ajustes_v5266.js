...
ok('painel na 205, fila fecha com o anti-tela-branca v6.0.12', manifest[manifest.length - 13] === 'painel_gerente_patch.js' && manifest[manifest.length - 12] === 'fiscal_guard_patch.js' && manifest[manifest.length - 11] === 'nf_transmissao_patch.js' && manifest[manifest.length - 10] === 'autocura_empresa_central_nf_tela_patch.js' && manifest[manifest.length - 9] === 'perfis_nuvem_cura_sessao_patch.js' && manifest[manifest.length - 8] === 'permissoes_estorno_venda_patch.js' && manifest[manifest.length - 7] === 'fiscal_menu_completo_patch.js' && manifest[manifest.length - 6] === 'dashboard_inicio_clicavel_patch.js' && manifest[manifest.length - 5] === 'menus_fiscais_separados_patch.js' && manifest[manifest.length - 4] === 'permissoes_override_menus_fiscais_patch.js' && manifest[manifest.length - 3] === 'seis_submenus_velho_patch.js' && manifest[manifest.length - 2] === 'submenu_hover_nfe_patch.js' && manifest[manifest.length - 1] === 'navegacao_sem_tela_branca_patch.js' && bundle.indexOf('PAINEL_GERENTE v5.26.6') >= 0);
...
ok('index.html carimbado', html.indexOf("DIGICOPY_APP_VERSION = '6.0.12'") >= 0 && html.indexOf('>v6.0.12<') >= 0);
