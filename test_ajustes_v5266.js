// test_ajustes_v5266.js — v5.26.6: PAINEL DO GERENTE (ordem dele: "faz logo").
...
ok('painel no bundle gerado (posição final do manifesto)', manifest[manifest.length - 1] === 'painel_gerente_patch.js' && bundle.indexOf('PAINEL_GERENTE v5.26.6') >= 0);
...
console.log('== CARIMBO 5.26.6 ==');
ok('package.json na 5.26.6', pkg.version === '5.26.6');
ok('index.html carimbado', html.indexOf("DIGICOPY_APP_VERSION = '5.26.6'") >= 0 && html.indexOf('>v5.26.6<') >= 0);
...
console.log('\nTudo OK — v5.26.6 (Painel do Gerente no ar: o dono vê tudo, de todos os PCs, numa tela só — lendo só a nuvem já sincronizada).');
