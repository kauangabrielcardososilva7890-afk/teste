...
ok('painel na 205, fila fecha com navegação fiscal firme + escuro íntegro v6.1.3', manifest[manifest.length - 19] === 'painel_gerente_patch.js' && manifest[manifest.length - 18] === 'fiscal_guard_patch.js' && manifest[manifest.length - 17] === 'nf_transmissao_patch.js' && manifest[manifest.length - 16] === 'autocura_empresa_central_nf_tela_patch.js' && manifest[manifest.length - 15] === 'perfis_nuvem_cura_sessao_patch.js' && manifest[manifest.length - 14] === 'permissoes_estorno_venda_patch.js' && manifest[manifest.length - 13] === 'fiscal_menu_completo_patch.js' && manifest[manifest.length - 12] === 'dashboard_inicio_clicavel_patch.js' && manifest[manifest.length - 11] === 'menus_fiscais_separados_patch.js' && manifest[manifest.length - 10] === 'permissoes_override_menus_fiscais_patch.js' && manifest[manifest.length - 9] === 'seis_submenus_velho_patch.js' && manifest[manifest.length - 8] === 'submenu_hover_nfe_patch.js' && manifest[manifest.length - 7] === 'navegacao_sem_tela_branca_patch.js' && manifest[manifest.length - 6] === 'ribbon_fiscal_estilo_antigo_patch.js' && manifest[manifest.length - 5] === 'fiscal_catalogo_completo_patch.js' && bundle.indexOf('PAINEL_GERENTE v5.26.6') >= 0);
