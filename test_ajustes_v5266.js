...
ok('painel na 205, fila fecha com navegação fiscal firme + escuro íntegro v6.1.2', manifest[manifest.length - 18] === 'painel_gerente_patch.js' && manifest[manifest.length - 17] === 'fiscal_guard_patch.js' && manifest[manifest.length - 16] === 'nf_transmissao_patch.js' && manifest[manifest.length - 15] === 'autocura_empresa_central_nf_tela_patch.js' && manifest[manifest.length - 14] === 'perfis_nuvem_cura_sessao_patch.js' && manifest[manifest.length - 13] === 'permissoes_estorno_venda_patch.js' && manifest[manifest.length - 12] === 'fiscal_menu_completo_patch.js' && manifest[manifest.length - 11] === 'dashboard_inicio_clicavel_patch.js' && manifest[manifest.length - 10] === 'menus_fiscais_separados_patch.js' && manifest[manifest.length - 9] === 'permissoes_override_menus_fiscais_patch.js' && manifest[manifest.length - 8] === 'seis_submenus_velho_patch.js' && manifest[manifest.length - 7] === 'submenu_hover_nfe_patch.js' && manifest[manifest.length - 6] === 'navegacao_sem_tela_branca_patch.js' && manifest[manifest.length - 5] === 'ribbon_fiscal_estilo_antigo_patch.js' && manifest[manifest.length - 4] === 'fiscal_catalogo_completo_patch.js' && bundle.indexOf('PAINEL_GERENTE v5.26.6') >= 0);
