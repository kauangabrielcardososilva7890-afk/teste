...
ok('painel na 205, fila fecha com o hover NF-e/NFC-e v6.0.11', manifest[manifest.length - 12] === 'painel_gerente_patch.js' && manifest[manifest.length - 11] === 'fiscal_guard_patch.js' && manifest[manifest.length - 10] === 'nf_transmissao_patch.js' && manifest[manifest.length - 9] === 'autocura_empresa_central_nf_tela_patch.js' && manifest[manifest.length - 8] === 'perfis_nuvem_cura_sessao_patch.js' && manifest[manifest.length - 7] === 'permissoes_estorno_venda_patch.js' && manifest[manifest.length - 6] === 'fiscal_menu_completo_patch.js' && manifest[manifest.length - 5] === 'dashboard_inicio_clicavel_patch.js' && manifest[manifest.length - 4] === 'menus_fiscais_separados_patch.js' && manifest[manifest.length - 3] === 'permissoes_override_menus_fiscais_patch.js' && manifest[manifest.length - 2] === 'seis_submenus_velho_patch.js' && manifest[manifest.length - 1] === 'submenu_hover_nfe_patch.js' && bundle.indexOf('PAINEL_GERENTE v5.26.6') >= 0);
...
ok('index.html carimbado', html.indexOf("DIGICOPY_APP_VERSION = '6.0.11'") >= 0 && html.indexOf('>v6.0.11<') >= 0);
