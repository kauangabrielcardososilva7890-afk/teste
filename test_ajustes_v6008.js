...
ok('manifesto sobe pra 213; menus separados fecha a fila',
  man.length === 221 && man[212] === 'menus_fiscais_separados_patch.js' && man[213] === 'permissoes_override_menus_fiscais_patch.js' && man[214] === 'seis_submenus_velho_patch.js' && man[215] === 'submenu_hover_nfe_patch.js' && man[211] === 'dashboard_inicio_clicavel_patch.js' && man[210] === 'fiscal_menu_completo_patch.js' && man[205] === 'fiscal_guard_patch.js');
...
ok('index.html carimbado (versão real + rodapé + query)',
  html.indexOf("DIGICOPY_APP_VERSION = '6.1.1'") >= 0 && html.indexOf('>v6.1.1<') >= 0 && html.indexOf('app.bundle.js?v=6.1.1') >= 0);
ok('celular carimbado 6.0.9', mob.indexOf("DIGICOPY_APP_VERSION = '6.1.1'") >= 0 && mob.indexOf('>v6.1.1<') >= 0);
