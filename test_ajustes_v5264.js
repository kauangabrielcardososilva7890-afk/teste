...
ok('manifesto: chamado na 204, Painel na 205, Portão na 206; v6.0.6 menu fiscal; Início clicável v6.0.7 fecha a fila (212; login-nuvem na 203)', manifest.length === 212 && manifest[203] === PATCH && manifest[204] === 'painel_gerente_patch.js' && manifest[205] === 'fiscal_guard_patch.js' && manifest[206] === 'nf_transmissao_patch.js');
