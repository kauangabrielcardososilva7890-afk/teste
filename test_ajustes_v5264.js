...
ok('manifesto: chamado na 204, Painel do Gerente na 205 e Portão Fiscal v6.0.0 fecha a fila (206; login-nuvem na 203)', manifest.length === 206 && manifest[203] === PATCH && manifest[204] === 'painel_gerente_patch.js' && manifest[205] === 'fiscal_guard_patch.js');
...
console.log('== CARIMBO (app agora em 6.0.0 após a escola; worker e gerente intactos) ==');
ok('package.json na 6.0.0', pkg.version === '6.0.0');
ok('index.html carimbado 6.0.0 (versão real + rodapé)', html.indexOf("DIGICOPY_APP_VERSION = '6.0.0'") >= 0 && html.indexOf('>v6.0.0<') >= 0);
