// Teste v5.24.26 — "abrir já mostrando o que eu escolhi" + 4.2 sem fantasma:
...
// v5.24.26 SUPERSEDEU o auto-abrir o 1º: a ficha agora desenha a LISTA do
...
ok(patch.indexOf('clitabRenderSoSelecionados(sub, ids)') >= 0, 'v5.24.26: a LISTA mostra os marcados (o 1º não abre mais sozinho)');
