...
(async function(){
  ...
  ok(man.length === 225 && man[man.length-26] === 'ajustes_v52436_leitura_uma_aberta_patch.js' && man[man.length-25] === 'ajustes_v5250_leitura_overhaul_patch.js' && man[man.length-24] === 'ajustes_v5260_cnpj_gerente_patch.js' && man[man.length-23] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && man[man.length-22] === 'ajustes_v5264_chamado_data_grande_patch.js' && man[man.length-21] === 'painel_gerente_patch.js' && man[man.length-20] === 'fiscal_guard_patch.js' && man[man.length-19] === 'nf_transmissao_patch.js' && man[man.length-18] === 'autocura_empresa_central_nf_tela_patch.js' && man[man.length-17] === 'perfis_nuvem_cura_sessao_patch.js' && man[man.length-16] === 'permissoes_estorno_venda_patch.js' && man[man.length-15] === 'fiscal_menu_completo_patch.js' && man[man.length-14] === 'dashboard_inicio_clicavel_patch.js' && man[man.length-13] === 'menus_fiscais_separados_patch.js' && man[man.length-12] === 'permissoes_override_menus_fiscais_patch.js' && man[man.length-11] === 'seis_submenus_velho_patch.js' && man[man.length-10] === 'submenu_hover_nfe_patch.js' && man[man.length-9] === 'navegacao_sem_tela_branca_patch.js' && man[man.length-8] === 'ribbon_fiscal_estilo_antigo_patch.js', 'manifest: 225 scripts; v6.0.13 ribbon bonita, depois fiscal 6.0.14→6.1.3, v6.1.7 soma o navegador embutido (NFS-e da prefeitura + WhatsApp Web) e v6.1.8 a memória da tela + a conferência da NF-e');
