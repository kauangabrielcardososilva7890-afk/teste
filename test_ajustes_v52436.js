...
(async function(){
  ...
  ok(man.length === 220 && man[man.length-21] === 'ajustes_v52436_leitura_uma_aberta_patch.js' && man[man.length-20] === 'ajustes_v5250_leitura_overhaul_patch.js' && man[man.length-19] === 'ajustes_v5260_cnpj_gerente_patch.js' && man[man.length-18] === 'ajustes_v5262_login_nuvem_primeiro_patch.js' && man[man.length-17] === 'ajustes_v5264_chamado_data_grande_patch.js' && man[man.length-16] === 'painel_gerente_patch.js' && man[man.length-15] === 'fiscal_guard_patch.js' && man[man.length-14] === 'nf_transmissao_patch.js' && man[man.length-13] === 'autocura_empresa_central_nf_tela_patch.js' && man[man.length-12] === 'perfis_nuvem_cura_sessao_patch.js' && man[man.length-11] === 'permissoes_estorno_venda_patch.js' && man[man.length-10] === 'fiscal_menu_completo_patch.js' && man[man.length-9] === 'dashboard_inicio_clicavel_patch.js' && man[man.length-8] === 'menus_fiscais_separados_patch.js' && man[man.length-7] === 'permissoes_override_menus_fiscais_patch.js' && man[man.length-6] === 'seis_submenus_velho_patch.js' && man[man.length-5] === 'submenu_hover_nfe_patch.js' && man[man.length-4] === 'navegacao_sem_tela_branca_patch.js' && man[man.length-3] === 'ribbon_fiscal_estilo_antigo_patch.js', 'manifest: 218 scripts; ribbon fiscal bonita v6.0.13 fecha a fila');
