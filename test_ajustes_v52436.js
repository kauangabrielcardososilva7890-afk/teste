...
(async function(){
  ...
  ok(fs.readFileSync('mobile/www/index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '6.0.3'"), 'celular 6.0.3');
  ok(JSON.parse(fs.readFileSync('package.json', 'utf8')).version === '6.0.3', 'package.json 6.0.3');
