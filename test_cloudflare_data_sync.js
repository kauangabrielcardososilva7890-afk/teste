...
ok('nuvem vazia + dados neste PC pede a escolha inicial',gEmpty.pause===true&&gEmpty.isolate===false&&gEmpty.reason==='escolha-inicial');
const gHold=S.decideReinstallGuard({activation:'recovery',cloudHasData:true,localCount:2000,extraCount:57});
ok('sobra local não sobe sozinha',gHold.pause===true&&gHold.hold===true&&gHold.isolate===false&&gHold.reason==='escolha-inicial');
