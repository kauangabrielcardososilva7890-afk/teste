...
ok('versão no rodapé', /v5\.22\.42/.test(html));
...
ok('versão no patch', /v5.22.42/.test(orc) && /v5.22.42/.test(fin) && pkg.version==='5.22.42' && html.includes('app.bundle.js?v=5.22.42'));
