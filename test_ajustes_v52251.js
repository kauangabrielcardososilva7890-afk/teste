...
ok('versão 5.22.51 base', P.VERSAO === '5.22.51' && /^5\.\d+\.\d+/.test(pkg.version));
...
ok('index carrega os scripts', /app\.bundle\.js\?v=5\.\d+\.\d+/.test(html) && JSON.parse(fs.readFileSync('bundle-manifest.json','utf8')).includes('ajustes_v52251_exe_resiliencia_patch.js'));
