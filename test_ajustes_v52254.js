...
ok('versão 5.22.54 base', P.VERSAO === '5.22.54' && /^[56]\.\d+\.\d+/.test(pkg.version));
...
ok('index carrega scripts na versão 5.22', /app\.bundle\.js\?v=[56]\.\d+\.\d+/.test(html) && JSON.parse(fs.readFileSync('bundle-manifest.json','utf8')).includes('ajustes_v52254_orcamentos_pages_patch.js'));
