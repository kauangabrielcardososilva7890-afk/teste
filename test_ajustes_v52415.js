// test_ajustes_v52415.js — v5.24.16: relato dele "salvou na nuvem mas alguns
...
ok(p.includes('v5.24.16'), 'carimbo v5.24.16 no painel de nuvem');
...
console.log('\nTudo OK — v5.24.16 (diagnóstico "por que dados não aparecem", custo zero de nuvem).');
