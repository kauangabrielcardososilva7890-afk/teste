// test_ajustes_v52415.js — v5.24.18: relato dele "salvou na nuvem mas alguns
...
ok(p.includes('v5.24.18'), 'carimbo v5.24.18 no painel de nuvem');
...
ok(idx.includes('>v5.24.18<'), 'index: rodapé 5.24.18');
ok(idx.includes('app.bundle.js?v=5.24.18'), 'index: cache-bust 5.24.18');
...
console.log('\nTudo OK — v5.24.18 (diagnóstico "por que dados não aparecem", custo zero de nuvem).');
