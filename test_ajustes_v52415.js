// test_ajustes_v52415.js — v5.24.29: relato dele "salvou na nuvem mas alguns
...
ok(p.includes('v5.24.29'), 'carimbo v5.24.29 no painel de nuvem');
...
ok(idx.includes('>v5.24.29<'), 'index: rodapé 5.24.29');
ok(idx.includes('app.bundle.js?v=5.24.29'), 'index: cache-bust 5.24.29');
...
console.log('\nTudo OK — v5.24.29 (diagnóstico "por que dados não aparecem", custo zero de nuvem).');
