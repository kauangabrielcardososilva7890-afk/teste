// test_ajustes_v52415.js — v5.24.25: relato dele "salvou na nuvem mas alguns
...
ok(p.includes('v5.24.25'), 'carimbo v5.24.25 no painel de nuvem');
...
console.log('\nTudo OK — v5.24.25 (diagnóstico "por que dados não aparecem", custo zero de nuvem).');
