...
ok('manifesto sobe pra 214; override+menus fecha a fila',
  man.length === 214 && man[213] === 'permissoes_override_menus_fiscais_patch.js' && man[212] === 'menus_fiscais_separados_patch.js' && man[211] === 'dashboard_inicio_clicavel_patch.js' && man[205] === 'fiscal_guard_patch.js');
...
ok('index.html carimbado', html.indexOf("DIGICOPY_APP_VERSION = '6.0.9'") >= 0 && html.indexOf('>v6.0.9<') >= 0 && html.indexOf('app.bundle.js?v=6.0.9') >= 0);
