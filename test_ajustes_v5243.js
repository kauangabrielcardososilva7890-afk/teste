// Teste v5.24.4 — segunda rodada do relatório pós-testes do dono:
...
ok(patch.indexOf("o.status='excluido'") >= 0, 'orçamento sai por marcação (modelo do sistema)');
...
if(falhas){ console.error('\n' + falhas + ' FALHA(S) v5.24.4'); process.exit(1); }
console.log('\nTudo certo v5.24.4!');
