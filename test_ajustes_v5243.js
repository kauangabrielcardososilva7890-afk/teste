// Teste v5.24.19 — segunda rodada do relatório pós-testes do dono:
...
ok(patch.indexOf("db.orcamentos=(banco.orcamentos||[]).filter(function(x){return x.id!==id;})") >= 0, 'orçamento excluído DE VEZ (v5.24.19: sem marca-fantasma)');
