...
(async function(){
  ...
  ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '6.0.0'"), 'index 6.0.0 (re-ancorado: v5.26.0 = CNPJ + gerente)');
  ok(fs.readFileSync('index.html', 'utf8').includes('>v6.0.0<'), 'rodapé v6.0.0 (re-ancorado: entrega grande ganhou a 2ª casa)');
