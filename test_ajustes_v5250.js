...
(async function(){
  ...
  ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.26.4'"), 'index 5.26.4 (re-ancorado: v5.26.0 = CNPJ + gerente)');
  ok(fs.readFileSync('index.html', 'utf8').includes('>v5.26.4<'), 'rodapé v5.26.4 (re-ancorado: entrega grande ganhou a 2ª casa)');
