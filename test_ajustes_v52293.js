...
ok(m.indexOf('ajustes_v52293_orcamento_guardiao_patch.js') === m.length - 6, 'guardião logo antes da fila final (depois vêm volta-venda, backups, o v5.24.0, as abas do cliente v5.24.3 e o remanejo final v5.24.35);');
