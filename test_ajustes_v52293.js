...
ok(m.indexOf('ajustes_v52293_orcamento_guardiao_patch.js') === m.length - 10, 'guardião logo antes da fila final (depois vêm volta-venda, backups, o v5.24.0, as abas do cliente v5.24.3, o remanejo final v5.24.35, a guarda de leitura v5.24.36, a revisão v5.25.0, o CNPJ+gerente v5.26.0 e o login da nuvem primeiro v5.26.2);');
