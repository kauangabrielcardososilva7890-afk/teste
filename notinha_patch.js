...
(function(){
  ...
  // v5.24.30 — RELATORIO dele (P11): a caixa classic também só aplica no Enter
...
(function(){
  ...
  if(input){
    ...
    // v5.24.30 — RELATORIO dele (P11): caixa só aplica no Enter ou no Filtrar.
