  ...
  if(typeof window !== 'undefined'){
    ...
    window.abrirTelaOrcamento = function(existente){
      ...
      document.getElementById('modal-body').innerHTML =
        ...
        +'<label class="col-span-12 md:col-span-2 text-[11px] font-bold uppercase text-[#0a1e8a]">Tipo<select id="orc-item-tipo" class="mt-1 w-full h-[40px] px-2 rounded-xl border bg-white text-[12px]"><option>Produto</option><option>Serviço</option><option>Recarga de toner</option></select></label>'
