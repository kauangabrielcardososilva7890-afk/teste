...
## ESTADO ATUAL DAS REGRAS (atualizado 2026-09-16 v5.25.0 — sobrepõe regras velhas do corpo)
- **Versão da verdade (rodapé): v5.25.0.** (lei nova: NF irá pro 6.xx.xx quando entrar) Número só anda pra frente; 2ª casa = relatório grande.
...
- **Suíte atual: 158/158 verde.** Bundle: 201 scripts com isolamento de erro.
