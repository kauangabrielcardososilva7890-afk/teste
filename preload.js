...
const pontes = {
  ...
  // API do erro.txt (v5.24.33) — só existe dentro do .exe; no navegador/celular
  ...
  // Abrir o contrato RTF já abrindo no Word (v5.24.33 — P6 do relatório dele).
  ...
  // API do monitor de impressoras (v5.24.33 — Fase 1): só dentro do .exe,
