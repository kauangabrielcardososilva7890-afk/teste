// test_ajustes_v5265.js — v6.0.1: O RALO DO BUSCADOR ESCOLA FECHADO DE VEZ.
//
...
console.log('== CARIMBO 6.0.1 (app; worker e gerente intactos) ==');
...
console.log('\nTudo OK — v6.0.1 (ralo da escola FECHADO: automático só trabalha com a aba aberta; abriu a aba já busca; deps vendorizadas, build e testes à prova de node_modules sumido).');
