// test_ajustes_v52419.js — v5.24.19: pedido dele "muda as informações da
...
ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.24.19'"), 'index: versão 5.24.19');
ok(fs.readFileSync('index.html', 'utf8').includes('>v5.24.19<'), 'index: rodapé v5.24.19');
ok(fs.readFileSync('package.json', 'utf8').includes('"version": "5.24.19"'), 'package.json 5.24.19');

if (falhas > 0) { console.error(`\n${falhas} assert(s) FALHARAM`); process.exit(1); }
console.log('\nTudo OK — v5.24.19 (informações da nuvem no idioma do plano pago).');
