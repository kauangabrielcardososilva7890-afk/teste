...
ok('versão 5.22.52 base', P.VERSAO === '5.22.52' && /^5\.\d+\.\d+/.test(pkg.version));
...
ok('index carrega os scripts na versão 5.22', /app\.bundle\.js\?v=5\.\d+\.\d+/.test(html) && JSON.parse(fs.readFileSync('bundle-manifest.json','utf8')).includes('ajustes_v52252_resolucao_loop_patch.js'));
