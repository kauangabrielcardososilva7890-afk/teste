...
ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '5.26.6'"), 'index 5.26.6 (re-ancorado)');
ok(fs.readFileSync('index.html', 'utf8').includes('>v5.26.6<'), 'rodapé v5.26.6 (re-ancorado)');
ok(fs.readFileSync('package.json', 'utf8').includes('"version": "5.26.6"'), 'package.json 5.26.6 (re-ancorado)');
