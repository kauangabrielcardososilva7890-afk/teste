...
ok(fs.readFileSync('index.html', 'utf8').includes("DIGICOPY_APP_VERSION = '6.0.9'"), 'index 6.0.9 (re-ancorado)');
ok(fs.readFileSync('index.html', 'utf8').includes('>v6.0.9<'), 'rodapé v6.0.9 (re-ancorado)');
ok(fs.readFileSync('package.json', 'utf8').includes('"version": "6.0.9"'), 'package.json 6.0.6 (re-ancorado)');
