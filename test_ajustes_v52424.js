// test_ajustes_v52424.js — v5.24.33: pedido dele "site próprio de atualizações".
...
ok(wk.includes('DigiCopy Downloads'), 'site: título = só o nome do site (supersede v5.24.33: pedido dele, página animada DigiCopy Downloads)');
...
console.log('\nTudo OK — v5.24.33 (site próprio de atualizações + histórico na nuvem).');
