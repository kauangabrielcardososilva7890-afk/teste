...
ok('manifesto sobe pra 211; menu fiscal completo fecha a fila', man.length === 211 && man[210] === 'fiscal_menu_completo_patch.js' && man[209] === 'permissoes_estorno_venda_patch.js' && man[205] === 'fiscal_guard_patch.js');
...
ok('celular carimbado 6.0.6', mob.indexOf("DIGICOPY_APP_VERSION = '6.0.6'") >= 0 && mob.indexOf('>v6.0.6<') >= 0);
