...
ok('manifesto sobe pra 215; 6 submenus do antigo fecha a fila',
  man.length === 219 && man[214] === 'seis_submenus_velho_patch.js' && man[215] === 'submenu_hover_nfe_patch.js' && man[213] === 'permissoes_override_menus_fiscais_patch.js' && man[205] === 'fiscal_guard_patch.js');
...
ok('package.json na 6.0.10', pkg.version === '6.0.14');
...
ok('celular carimbado 6.0.10', mob.indexOf("DIGICOPY_APP_VERSION = '6.0.14'") >= 0 && mob.indexOf('>v6.0.14<') >= 0);
